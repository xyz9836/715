...
def add_function():
    ...
    return dict(convert_to_yuan=convert_to_yuan, get_device_type=get_device_type, get_device_root=get_device_root,int2ip=int2ip, convert_to_yuanjiaofen=convert_to_yuanjiaofen)
